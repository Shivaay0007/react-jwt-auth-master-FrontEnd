...
import { FaFontAwesome, FaTruckMoving } from "react-icons/fa";
          ...
          <div className="row">
            <div className="col-md-9">
                      ...
                      <tr>
                        ...
                        <td className="text-right">
                          ...
                          <button className="btn btn-sm btn-outline-danger">
                            <BsFillTrashFill className="i-va" />
                          </button>
                        </td>
                      </tr>
                    </tbody>
              ...
              <div className="alert alert-success mt-3">
                <p className="m-0">
                  <FaTruckMoving className="i-va mr-2" /> Free Delivery within
                  1-2 weeks
                </p>
              </div>
            </div>
